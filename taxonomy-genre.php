...
<div id="content" class="content-work">
    <div class="inner">
        ...
        <main id="primary">
            ...
            <div class="genre-nav">
                <div class="genre-nav-link"><a href="<?php echo esc_url(get_post_type_archive_link('work')); ?>">すべて</a></div><!-- /.genre-nav-link -->
                <?php
                $genre_terms = get_terms('genre', array('hide_empty' => false));
                foreach ($genre_terms as $genre_term) :
                ?>
                    <?php
                    if (get_queried_object() == $genre_term) :
                    ?>
                        <div class="genre-nav-link"><a class="is-active" href="<?php echo esc_url(get_term_link($genre_term, 'genre')); ?>"><?php echo esc_html($genre_term->name); ?></a></div><!-- /.genre-nav-link -->
                    <?php else : ?>
                    ...
                    ?>
                        ...
                        <a href="<?php the_permalink(); ?>" <?php post_class(array('entry-item', 'entry-item-horizontal')); ?>>
                            ...
                            <div class="entry-item-body">
                                ...
                                <div class="entry-item-excerpt"><?php echo mb_substr(get_field('overview'),0,40,"UTF-8"); ?></div><!-- /.entry-item-excerpt -->
                            </div><!-- /.entry-item-body -->
