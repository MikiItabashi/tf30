...
function my_script_init()
{
  ...
  wp_enqueue_style('my', get_template_directory_uri() . '/css/tomorrow-night-eighties.css', array(), '1.0.0', 'all');
  wp_enqueue_style('highlight', get_template_directory_uri() . '/css/style.css', array(), '1.0.0', 'all');
  wp_enqueue_script('my', get_template_directory_uri() . '/js/highlight.pack.js', array('jquery'), '1.0.0', true);
  wp_enqueue_script('highlight', get_template_directory_uri() . '/js/script.js', array('jquery'), '1.0.0', true);
  //sns.jsを追記
  if (is_single()) {
